...
Desktop digital whiteboard and drawing tool based on [tldraw](https://github.com/tldraw/tldraw)

## Development

Built with [Wails](https://wails.io/) and [React](https://react.dev). You will need the following
installed:
